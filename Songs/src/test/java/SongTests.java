...
public class SongTests {
    ...
    private model.Song testSong;

    @Before
    public void init(){
        System.setOut(new PrintStream(out));
        this.testSong = new model.Song("TestSong", "TestSongGenre", 71, "Test song lyrics");
    }
    ...
    public void shouldPrintSongDurations(){
        ...
        Assert.assertEquals("model.Song duration: 1:11", out.toString().trim());
    }
    ...
    public void shouldReturnCorrectMessageWithDifferentGenres(){
        ...
        Assert.assertEquals("enumeration.Genre doesn't match!", out.toString().trim());
    }
